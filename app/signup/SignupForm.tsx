...
export function SignupForm() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    // user_metadata carries full_name/org_name through to LoginForm's
    // ensureOrgAndMembership() for the case below where confirmation is
    // required and we don't get a session (so can't write to the DB) yet.
    ...
    if (!data.session) {
      ...
      // confirms and logs in (see LoginForm.tsx).
